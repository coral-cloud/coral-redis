package org.turkey.common.command;
...
public interface Commands {
  ...
  /**
   * @deprecated Use {@link #expire(String, long)}.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link #setex(String, long, String)}.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link #restore(String, long, byte[])}.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link #restore(String, long, byte[], RestoreParams)}.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link #xrange(String, StreamEntryID, StreamEntryID, int)}.
   */
  @Deprecated
